...
void transmit(bool pee, bool poo)
{
  ...
  if(client) {
...

    {
      ...
      char macBuffer[15];
      sprintf(macBuffer, "%06x", mac);
      String macString = String(macBuffer);

      char serverPathBuffer[300];
      sprintf(serverPathBuffer, "%s?coreid=%s&published_at=%s&data=[%d,%d]", url, macString, timeBuf, pee, poo);
...
void loop() {
  bool blue = !digitalRead(26);
  bool green = !digitalRead(25);
  bool red = !digitalRead(33);
